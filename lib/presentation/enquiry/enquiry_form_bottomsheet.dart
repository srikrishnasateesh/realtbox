...
class BottomSheetWidget extends StatefulWidget {
  ...
  const BottomSheetWidget({super.key, required this.propertyId});
...
class _BottomSheetWidgetState extends State<BottomSheetWidget> {
  ...
  void initState() {
    ...
    BlocProvider.of<EnquiryBloc>(context)
        .add(OnAppStarted(id: widget.propertyId));
  }
                ...
                Center(
                  child: BlocBuilder<EnquiryBloc, EnquiryState>(
                    builder: (context, state) {
                      if (state is ShowConfirmationMessage) {
                        return Center(
                          child: Column(
                      ...
                      return Column(
                        ...
                        children: [
                          ...
                          TextField(
                            ...
                            onChanged: (value) =>
                                BlocProvider.of<EnquiryBloc>(context)
                                    .add(OnMobileNumberChanged(text: value)),
                          ),
                          const SizedBox(height: 20),
                          TextField(
