...
String? extractYouTubeId(String url) {
  ...
  if (match != null && match.groupCount >= 1) {
    return match
        .group(1); // Extracts the first capturing group, which is the video ID.
  }
...
bool isInitialized(Object? variable) {
  try {
    debugPrint("isInitialized try");
    variable
        .toString(); // This will throw an error if the variable is not initialized.
    return true;
  } catch (e) {
    debugPrint("isInitialized false");
    return false;
  }
}
